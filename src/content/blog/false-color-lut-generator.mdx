...
import imgSample01 from "../../assets/background.svg";
import imgSample02 from "../../assets/astro.svg";
...
<Gallery
  images={[
    { src: imgSample01, alt: "Sample False Color output 1" },
    { src: imgSample02, alt: "Sample False Color output 2" },
  ]}
/>
